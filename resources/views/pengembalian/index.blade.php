                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            ...
                            <a href="{{ route('pengembalian.create') }}" class="btn btn-primary mb-2">Tambah</a>
                            ...
                            <table class="table table-bordered" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($pengembalian as $data)
                                        <tr>
                                            <td>{{ $no++ }}</td>
                                            <td><center>{{ $data->pinjaman->peminjam}}</center></td>
                                            ...
                                            <form action="{{ route('pengembalian.destroy', $data->id) }}" method="POST">
                                                ...
                                                @method('DELETE')
                                                <td class="center">
                                                    <a href="{{ route('pengembalian.edit', $data->id) }}" class="btn btn-success mx-1">Ubah</a>
